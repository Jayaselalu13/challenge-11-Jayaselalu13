...
const MusicPlayer = () => {
  ...
  const tracks = [
    {
      id: 1,
      src: '/music/Who I Am - Alan Walker, Putri Ariani, Peder Elias.mp3',
      title: 'Who I Am',
      artist: '- Alan Walker, Putri Ariani, Peder Elias',
    },
    {
      id: 2,
      src: '/music/Tersirat di Balik Senyuman - Brunetta Gondola.mp3',
      title: 'Tersirat di Balik Senyuman',
      artist: 'Brunetta Gondola',
    },
    {
      id: 3,
      src: '/music/Nur Wenn Ich Will (AI-Prinz) - HMS.mp3',
      title: 'Nur Wenn Ich Will (AI-Prinz)',
      artist: 'HMS',
    },
    {
      id: 4,
      src: '/music/🔥 _I Am the Dream Dreaming Me_ - HMS.mp3',
      title: '🔥 _I Am the Dream Dreaming Me_ ',
      artist: 'HMS',
    },
    {
      id: 5,
      src: '/music/Matahariku - AGNEZ MO (cover lagu).mp3',
      title: 'Matahariku',
      artist: 'AGNEZ MO (cover lagu)',
    },
    {
      id: 6,
      src: '/music/Dealova - Once Mekel (Live at Music Everywhere).mp3',
      title: 'Dealova',
      artist: 'Once Mekel',
    },
    {
      id: 7,
      src: '/music/A Morning Hum - HMS.mp3',
      title: 'A Morning Hum',
      artist: 'HMS',
    },
    {
      id: 8,
      src: '/music/A Morning Hum (Remix) - HMS.mp3',
      title: 'A Morning Hum (Remix)',
      artist: 'HMS',
    },
    {
      id: 9,
      src: '/music/🌸 花の香りに (Hana no Kaori ni) 🌸 - 花野かおり.mp3',
      title: '🌸 花の香りに (Hana no Kaori ni) 🌸',
      artist: '花野かおり',
    },
    {
      id: 10,
      src: '/music/Debugin Hidup - HMS.mp3',
      title: 'Debugin Hidup',
      artist: 'HMS',
    },
  ];
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex flex-col' style={{ paddingBottom: '20px' }}>
            ...
            <div
              ...
              style={{ paddingLeft: '144px', marginTop: '20px' }}
            >
              <div
          ...
          >
            <motion.div
              ...
              style={{
                ...
                backgroundColor:
                  playerState === 'playing' ? '#8b5cf6' : '#717680',
                width: `${progress}%`,
          ...
          >
            <span className='text-xs-regular' style={{ color: '#717680' }}>
          ...
          >
            ...
            <motion.button
              ...
              style={{
                ...
                padding: '8px',
                backgroundColor:
                  loopMode !== 'off' ? 'rgba(139,92,246,0.1)' : 'transparent',
